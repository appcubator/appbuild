var NavbarEditorView = require('template_editor/NavbarEditorView').NavbarEditorView;
var LinkEditorView = require('template_editor/LinkEditorView').LinkEditorView;
function (NavbarEditorView, LinkEditorView) {
    ...
    var FooterEditorView = NavbarEditorView.extend({
        ...
        addLinkEditorView: function (linkModel) {
            ...
            var newLinkEditor = new LinkEditorView({
                model: newLink
            });
