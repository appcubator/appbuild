            ...
            render: function () {
                ...
                var URLInput = React.createClass({
                    ...
                    getInitialState: function () {
                        return {
                            value: model.get('data').get('container_info').get('youtubeURL')
                        };
                    },
                    ...
                    render: function () {
                        return React.DOM.div({
                            ...
                            children: [
                                React.DOM.div({
                                    children: "Please copy paste the link of your video to the text box below.",
                                ...
                                React.DOM.input({
                                    ...
                                    className: "full-width",
                                    placeholder: "Example: http://www.youtube.com/watch?v=31AhaWyY1y4"
                                })
                            ]
                        });
                    }
