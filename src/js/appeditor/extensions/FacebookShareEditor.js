            ...
            render: function () {
                ...
                var Component = React.createClass({
                    ...
                    getInitialState: function () {
                        return {
                            hasLink: model.get('data').get('container_info').has('pageLink'),
                    ...
                    render: function () {
                        return React.DOM.div({
                            ...
                            children: [
                                React.DOM.div({
                                    children: "Please add the link of your Facebook Page if you would like to connect it to the Facebook button.",
